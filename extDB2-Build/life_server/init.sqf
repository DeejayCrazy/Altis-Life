...
if(isNil {GVAR_UINS "life_sql_id"}) then {
	...
	if ((parseNumber _result) < 65) exitWith {EXTDB_FAILED("extDB version is not compatible with current Altis life version. Require version 65 or higher. Visit https://github.com/Torndeco/extDB2/releases")};
